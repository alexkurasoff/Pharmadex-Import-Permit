    ...
    footer(){
        ...
        if(this.state.type===100){
            ret=<ModalFooter>
                    <Row>
                        <Col  className="col-6">
                            <Button color='primary' size="sm" className="float-right" onClick={()=>this.answerNo()}>{this.state.labels.global_no} </Button>
                        </Col>
                        <Col  className="col-6">
                            <Button color='secondary' outline size="sm" className="float-right" onClick={()=>this.answerYes()}>{this.state.labels.global_yes} </Button>
                        </Col>
                    </Row>
                </ModalFooter>
        }
        if(this.state.type===200){
            ...
            <Row>
                <Col  className="col-6">
                    <Button color='primary' size="sm" className="float-right" onClick={()=>this.answerYes()}>{this.state.labels.yes} </Button>
                </Col>
            </Row>
        </ModalFooter>
        }
