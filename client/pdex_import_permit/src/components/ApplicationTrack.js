...
/**
 * Track an application. User cannot move an application, track only
 * @property {number} applId
 * @example <ApplicationTrack applId={this.props.applId} />
 */
class ApplicationTrack extends Component{
    constructor(props){
        super(props)
        this.state={
            alertColor:"info",
    ...
    loadData(){
        ...
        Fetchers.postJSON("/api/common/application/track",this.state.data,(query,result)=>{
    ...
    buildTitle(){
        var title = this.state.data.pipStatus.value.code + " (" + this.state.data.orderType.value.description + ", " + this.state.data.itemType.value.code + ")"
        return title
    }
                ...
                <CardBody>
                    <Row>
                        ...
                        <Col xs='12' sm='12' lg='6' xl='6'>
                            ...
                            <Row>
                                <Col>
                                    <FinalizeMarkup appId={this.props.appId} readOnly={true} strict={false} />
                                </Col>
                            </Row>
                            <Row>
                                <Col>
